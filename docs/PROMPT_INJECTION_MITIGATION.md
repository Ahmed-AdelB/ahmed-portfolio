...
*   **Sandwich Defense:** Place critical instructions *after* the user's input in the messages array (if the API supports it) or reinforce them at the end of the system prompt.
