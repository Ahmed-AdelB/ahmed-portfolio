...
const NAMES_OF_ALLAH = [
  ...
  },
  {
    ar: "Al-Malik",
    en: "The King",
    meaning: "The Sovereign Lord, The One with the complete Dominion",
  },
  {
    ar: "Al-Quddus",
    en: "The Most Holy",
    meaning: "The One who is pure from any imperfection",
  },
  {
    ar: "As-Salam",
    en: "The Source of Peace",
    meaning:
      "The One who is free from every imperfection and safety from every defect",
  },
];
...
export function useIslamicEasterEggs(): UseIslamicEasterEggsReturn {
  ...
  useEffect(() => {
    ...
    if (inputBuffer.endsWith("bismillah")) {
      ...
      setActiveEgg("99");
      const randomName =
        NAMES_OF_ALLAH[Math.floor(Math.random() * NAMES_OF_ALLAH.length)];
