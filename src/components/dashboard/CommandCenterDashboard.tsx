...
import { challenges } from "../../data/security-challenges";
...
const SystemStatus = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setMem((prev) =>
        Math.min(100, Math.max(0, prev + (Math.random() * 5 - 2.5))),
      );
          ...
          >
            ...
            <div>
              ...
              <p className="text-zinc-500 text-xs mt-1">
                {challenge.context.substring(0, 60)}...
              </p>
          ...
          {logs.map((log) => (
            ...
            >
              ...
              <span
                className={
                  log.action === "Blocked"
                    ? "text-green-500 font-bold w-20 shrink-0"
                    : log.action === "Detected"
                      ? "text-red-500 font-bold w-20 shrink-0"
  ...
  return (
    <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg p-4">
      ...
      <div className="grid grid-cols-2 gap-2">
        <button
          className="bg-zinc-800 hover:bg-zinc-700 text-zinc-300 p-2 rounded text-xs font-mono transition-colors text-left flex items-center gap-2"
