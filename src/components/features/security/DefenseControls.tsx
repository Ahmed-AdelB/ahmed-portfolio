...
import type { DefenseId, DefenseMechanism } from "../../../types/security";

interface DefenseControlsProps {
  defenseMechanisms: ReadonlyArray<DefenseMechanism>;
  enabledDefenses: Record<DefenseId, boolean>;
  onToggleDefense: (id: DefenseId) => void;
  hardenedPrompt: string;
}

export const DefenseControls: FC<DefenseControlsProps> = ({
  defenseMechanisms,
  enabledDefenses,
  onToggleDefense,
  hardenedPrompt,
